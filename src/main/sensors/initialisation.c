...
#if defined(CONFIG_GYRO_MPU6050) || defined(CONFIG_GYRO_MPU3050) || defined(CONFIG_GYRO_MPU6500) || defined(USE_GYRO_SPI_MPU6500) || defined(USE_GYRO_SPI_MPU6000) || defined(CONFIG_ACC_MPU6050)
